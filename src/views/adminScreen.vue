<template>
    <div>
        <div class="flex w-full h-[550px] bg-[url('/src/assets/home/homeScreen.png')] bg-cover bg-blend-multiply bg-white top-0">
            <div class="flex flex-col my-auto px-6 sm:px-12 md:px-24 lg:px-32 w-full xl:w-3/4 pt-24 lg:pt-24">
        ...
        <div class="flex flex-col xl:flex-row items-center md:items-end py-16 md:py-32 space-x-24 lg:space-x-32 space-y-24 lg:space-y-0 px-6 sm:px-12 md:px-24 lg:px-32">
