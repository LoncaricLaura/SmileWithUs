<template>
    <div class="flex flex-col">
        <div class="flex justify-center items-center w-full h-[400px] bg-[#EFF4FC] bg-opacity-75 pt-0 md:pt-8 px-6 md:px-24 lg:px-32">
            <div class="text-5xl md:text-6xl text-left text-transparent bg-clip-text bg-gradient-to-r from-[#244B8E] to-[#385B97] font-bold py-16">Choose your dream dental ordination!</div>
        </div>
        <div class="w-full px-12 md:px-24 lg:px-32 py-16">
            <div class=" mx-auto w-full">
                <RadioGroup v-model="selected">
                    ...
                    <div class="grid md:grid-cols-2 md:grid-rows-5 lg:grid-cols-5 lg:grid-rows-2 gap-4 lg:gap-8">
                        <RadioGroupOption
