<template>
    <div class="flex flex-col">
        <div class="flex flex-col justify-center items-center w-full h-[480px] lg:h-[380px] bg-[#EFF4FC] bg-opacity-75 pt-0 md:pt-8 px-6 md:px-24 lg:px-32">
            <div class="text-5xl md:text-6xl text-left text-transparent bg-clip-text bg-gradient-to-r from-[#244B8E] to-[#385B97] font-bold py-12 mt-8">Select an appointment</div>
            ...
            <img src="/src/assets/backarrow.svg" class="flex self-start w-8 cursor-pointer my-4" @click="goBack()"/>
        </div>
        <div class="flex justify-center w-full px-6 md:px-32 py-6 md:py-12">
            ...
            <router-link to="/sucessOrder" @click="setOrder()" :disabled="date == ''" class="mx-auto bg-[#385B97] text-white text-md sm:text-xl text-center p-3 w-64 font-semibold font-display hover:bg-[#244B8E] rounded-full my-16 cursor-pointer">
                Place an order
            </router-link>
    </div>
</template>
